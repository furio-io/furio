...
describe("FullTest", function () {
    ...
    beforeEach(async function () {
        ...
        furaddressbook = await FurAddressBook.deploy();
        USDC = await ethers.getContractFactory("MockUSDC");
        usdc = await USDC.deploy();
        await furaddressbook.setPaymentToken(usdc.address);
        Whitelist = await ethers.getContractFactory("Whitelist");
        whitelist = await Whitelist.deploy(furaddressbook.address);
        await furaddressbook.setWhitelist(whitelist.address);
        FurToken = await ethers.getContractFactory("FurToken");
        furtoken = await FurToken.deploy(furaddressbook.address);
        await furaddressbook.setFurToken(furtoken.address);
        NFT = await ethers.getContractFactory("NFT");
        nft = await NFT.deploy(furaddressbook.address);
    });
    // TESTS
